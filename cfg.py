...
def get_cfg():
    ...
    parser.add_argument("--K_epoch", type=int, default=5, help="K-epoch")
    ...
    parser.add_argument("--hidden_size_obs", type=int, default=166, help="")
    parser.add_argument("--hidden_size_comm", type=int, default=166, help="")
    parser.add_argument("--hidden_size_action", type=int, default=166, help="")
    parser.add_argument("--n_representation_obs", type=int, default=56, help="")
    parser.add_argument("--n_representation_comm", type=int, default=56, help="")
    parser.add_argument("--n_representation_action", type=int, default=56, help="")
    parser.add_argument("--graph_embedding", type=int, default=56, help="")
