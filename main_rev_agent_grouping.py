...
def main():
    ...
    n_representation_action = int(os.environ.get("n_representation_action", 42))  # cfg.n_representation_comm
    n_representation_comm = int(os.environ.get("n_representation_comm", 42))#cfg.n_representation_comm
    graph_embedding = int(os.environ.get("graph_embedding", 48))
    ...
    learning_rate_graph = float(os.environ.get("learning_rate_graph",5.0e-5))  # cfg.lr
