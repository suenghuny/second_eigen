...
def main():
    ...
    learning_rate_graph = float(os.environ.get("learning_rate_graph", 5e-5))  # cfg.lr
    ...
    gamma1 = float(os.environ.get("gamma1", 0.00005))
    gamma2 = float(os.environ.get("gamma2", 0.00025))
